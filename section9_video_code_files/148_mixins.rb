...
class Pt
  attr_accessor :x, :y
  include Doubler # dodavanje mixina
  def + other
    ans = Pt.new
...
# 4 <=> 3 -vraća 1 (spaceship operator), comparable daje <,==, >, ... i vraća boolean
# "a" <=> "b" - 0
# r1 = MyRange.new(5,12)
# r1.each {|i| puts i} - ispisuje range elem.
# r1.count {|i| i.odd? } - count implementirano kroz mixin
